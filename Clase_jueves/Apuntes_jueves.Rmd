...
continuaremos con el siguiente modelo estadístico.
...
```{r}
# Cambiar nombres de renglones en el heatmap
...
# Cambiar el valor de show_rownames de FALSE a TRUE
pheatmap(
    exprs_heatmap,
    cluster_rows = TRUE,
    cluster_cols = TRUE,
...
```{r}
# PDF largo para poder ver los nombres de los genes
